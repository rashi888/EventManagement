...
const UserRegister = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (user.companyId === "Capgemini Bangalore") {
      user.companyId = 1;
    } else {
      user.companyId = 2;
    }
    ...
    axios.post('http://localhost:8080/employee/employeeregister', user, {
      headers: {
        ...
        >
          ...
          <div class="mb-4">
            ...
            >
              ...
              <option value="Capgemini Bangalore">Capgemini Bangalore</option>
            </select>
          </div>
          <div class="mb-4">
            <label
